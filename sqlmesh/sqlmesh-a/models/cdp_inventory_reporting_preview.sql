MODEL (
  name test.cdp_inventory_reporting_preview,
  kind FULL,
  cron '@daily',
  grain (stock_date),
  description 'Daily inventory metrics aggregated by date.'
);

/*
Daily inventory metrics aggregated by date.
...
with inventory_data as (
    select
        ...
        creation_date_time
    from test.sdp_inventory_vehicles_preview
