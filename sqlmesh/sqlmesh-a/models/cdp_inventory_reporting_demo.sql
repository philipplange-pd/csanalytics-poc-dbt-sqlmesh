MODEL (
  name test.cdp_inventory_reporting_demo,
  kind FULL,
  cron '@daily',
  description 'Daily inquiry metrics aggregated by date, vehicle, and inquiry characteristics',
  grain (stock_date, region, market, country, vehicle_condition, model_series, vehicle_type, engine_type, dealer_name)
);

with inventory_data as (
    select *
    from test.agg_inventory_reporting_demo
),
